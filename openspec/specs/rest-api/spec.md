...
This capability defines the baseline behavior for a Java 25 Spring Boot 4.1.1 application that exposes a simple REST API for health checks and service responses.
